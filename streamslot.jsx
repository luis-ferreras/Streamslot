...
function Dashboard() {
  ...
  const nbaTeams = [
    { name: 'Hawks', city: 'Atlanta', abbr: 'ATL', primary: '#C8102E', secondary: '#C1D32F', logo: 'https://a.espncdn.com/i/teamlogos/nba/500/atl.png' },
    ...
    { name: 'Pelicans', city: 'New Orleans', abbr: 'NOP', primary: '#0C2340', secondary: '#C8102E', logo: './images/nba/pelicans.png' },
